...
def train():
    ...
    # batch_iterator = iter(ocrdataloader)
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        # load train data
        #images, target, height, width, text, text_length, rois = next(batch_iterator)
        try:
        ...
        if iteration != 0 and iteration % args.save_iter == 0:
            ...
            torch.save(state,
                       'weights/ssd300_OCR_' + repr(iteration) + '.pth')
